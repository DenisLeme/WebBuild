...
import LemeImage from "./Leme.png";
  ...
  return (
    <div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          <div className="home-logo">
            <img alt="image" src={LemeImage} className="home-image" />
            <p className="name-nav">WebBuild Innovations</p>
          </div>
      ...
      <div className="home-hero">
        ...
        <div>
          <img alt="image" src={LemeImage} className="home-image2" />
          <p className="home-name">WebBuild Innovation</p>
        </div>
      </div>
